...
export function generateStackBadges(stacks) {
    return stacks
        .map((stack) => mapStacks[stack.toLowerCase().trim()] ||
        `![${stack}](https://img.shields.io/badge/${encodeURIComponent(stack)}-lightgrey?style=for-the-badge)`)
        .join(" ");
}
